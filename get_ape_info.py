...
api_url = "https://eth-mainnet.g.alchemy.com/v2/WhX6fKzlOpjrJHeXbsx6Eg1cLfrjHIj3"  # YOU WILL NEED TO PROVIDE THE URL OF AN ETHEREUM NODE
...
def get_ape_info(ape_id):
    ...
    metadata = requests.get(f"https://ipfs.io/ipfs/{ipfs_hash}").json()
